...
public class Exercise005Test {
    ...
    @Test
    public void checkSentenceWithRepeatingLettersIsAPangram() {
        assertTrue(ex005.isPangram("the quick quick brown fox jumps over the lazy dogs"));
    }

    @Test
    public void checkSentenceWithOnlyNumbersIsNotAPangram() {
        assertFalse(ex005.isPangram("1234566890"));
    }
    @Test
    public void checkSentenceWithAtSignIsAPangram() {
        assertTrue(ex005.isPangram("abcdefghijklmno@@@pqrstuvwxyz"));
    }
    @Test
    public void checkSentenceWithMissingJIsNotAPangram() {
        assertFalse(ex005.isPangram("the quick brown fox umps over the lazy dogs"));
    }
